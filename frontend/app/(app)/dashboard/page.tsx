  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between">
        ...
        {can("ANALYST") && <Link href="/"><Button variant="primary">＋ Nueva llamada</Button></Link>}
      </div>
      ...
      {noData ? (
        <Card><Empty title="Aún no hay llamadas analizadas" text="Suba una grabación para ver aquí la satisfacción, las emociones y su evolución." action={<Link href="/"><Button variant="primary">Subir llamada</Button></Link>} /></Card>
      ) : (
        <>
